...
class basic3_Tests extends FreeSpec with ScalaCheckPropertyChecks with Matchers with HaskellTest {
  ...
  "44" in {
    test(
      """((((((((((((((((((((((((((((((x))))))))))))))))))))))))))))))*""",
      """xx""",
      "(0,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)(1,2)"
    ) shouldBe true
  }
  ...
  "49" in {
    test("""aaaa|bbbb|cccc|ddddd|eeeeee|fffffff|gggg|hhhh|iiiii|jjjjj|kkkkk|llll""",
  ...
  "95" in {
    test("""M[ou]'?am+[ae]r_.*([AEae]l[-_])?[GKQ]h?[aeu]+([dtz][dhz]?)+af[iy]""",
         """Muammar_Qaddafi""",
         "(0,15)(?,?)(10,12)") shouldBe true
  }

  "96" in {
    test("""M[ou]'?am+[ae]r_.*([AEae]l[-_])?[GKQ]h?[aeu]+([dtz][dhz]?)+af[iy]""",
         """Mo'ammar_Gadhafi""",
         "(0,16)(?,?)(11,13)") shouldBe true
  }
  ...
  "99" in {
    test("""M[ou]'?am+[ae]r_.*([AEae]l[-_])?[GKQ]h?[aeu]+([dtz][dhz]?)+af[iy]""",
         """Muammar_Gadafi""",
         "(0,14)(?,?)(10,11)") shouldBe true
  }

  "100" in {
    test("""M[ou]'?am+[ae]r_.*([AEae]l[-_])?[GKQ]h?[aeu]+([dtz][dhz]?)+af[iy]""",
         """Mu'ammar_Qadafi""",
         "(0,15)(?,?)(11,12)") shouldBe true
  }

  "101" in {
    test("""M[ou]'?am+[ae]r_.*([AEae]l[-_])?[GKQ]h?[aeu]+([dtz][dhz]?)+af[iy]""",
         """Moamar_Gaddafi""",
         "(0,14)(?,?)(9,11)") shouldBe true
  }

  "102" in {
    test("""M[ou]'?am+[ae]r_.*([AEae]l[-_])?[GKQ]h?[aeu]+([dtz][dhz]?)+af[iy]""",
         """Mu'ammar_Qadhdhafi""",
         "(0,18)(?,?)(13,15)") shouldBe true
  }
