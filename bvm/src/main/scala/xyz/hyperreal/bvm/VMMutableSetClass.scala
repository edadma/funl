...
class VMMutableSet private[bvm] (set: mutable.Set[VMObject]) extends VMNonResizableIterable with VMNonSequence {
...
object VMEmptyMutableSet extends VMNonResizableIterable with VMNonSequence {
