...
import xyz.hyperreal.prolog.symbolOrdering
...
object ImplementationDefined {
  ...
  def set_prolog_flag(vm: VM, pos: IndexedSeq[CharReader], flag: Any, value: Any) =
    (flag, value) match {
  ...
  def current_prolog_flag(vm: VM, pos: IndexedSeq[CharReader], flag: Any, value: Any) =
    flag match {
      case _: vm.Variable =>
